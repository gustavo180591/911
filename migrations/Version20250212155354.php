 ...
 */
final class Version20250212155354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE denuncia (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, descripcion LONGTEXT NOT NULL, fecha_hora DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', direccion VARCHAR(255) DEFAULT NULL, INDEX IDX_F42367963397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, rol_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, dni VARCHAR(20) DEFAULT NULL, telefono VARCHAR(20) DEFAULT NULL, fecha_nacimiento DATE DEFAULT NULL, direccion VARCHAR(255) DEFAULT NULL, genero VARCHAR(255) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, fecha_registro DATETIME NOT NULL, UNIQUE INDEX UNIQ_2265B05DE7927C74 (email), UNIQUE INDEX UNIQ_2265B05D7F8F253B (dni), INDEX IDX_2265B05D4BAB96C (rol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
