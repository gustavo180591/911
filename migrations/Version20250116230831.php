 ...
 */
final class Version20250116230831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE denuncia (id INT AUTO_INCREMENT NOT NULL, estado_id INT NOT NULL, categoria_id INT NOT NULL, ubicacion_id INT NOT NULL, usuario_id INT NOT NULL, descripcion LONGTEXT NOT NULL, fecha_hora DATETIME NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_actualizacion DATETIME DEFAULT NULL, INDEX IDX_F42367969F5A440B (estado_id), INDEX IDX_F42367963397707A (categoria_id), INDEX IDX_F423679657E759E8 (ubicacion_id), INDEX IDX_F4236796DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evidencia (id INT AUTO_INCREMENT NOT NULL, denuncia_id INT NOT NULL, tipo VARCHAR(50) NOT NULL, ruta_archivo VARCHAR(255) NOT NULL, fecha_subida DATETIME NOT NULL, INDEX IDX_59B9807C17048D94 (denuncia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rol (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, descripcion LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_E553F373A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rol_permiso (rol_id INT NOT NULL, permiso_id INT NOT NULL, INDEX IDX_BB62E2194BAB96C (rol_id), INDEX IDX_BB62E2196CEFAD37 (permiso_id), PRIMARY KEY(rol_id, permiso_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, rol_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, dni VARCHAR(20) NOT NULL, telefono VARCHAR(20) DEFAULT NULL, fecha_nacimiento DATE DEFAULT NULL, genero VARCHAR(10) DEFAULT NULL, fecha_registro DATETIME NOT NULL, UNIQUE INDEX UNIQ_2265B05DE7927C74 (email), UNIQUE INDEX UNIQ_2265B05D7F8F253B (dni), INDEX IDX_2265B05D4BAB96C (rol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rol_permiso ADD CONSTRAINT FK_BB62E2194BAB96C FOREIGN KEY (rol_id) REFERENCES rol (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rol_permiso ADD CONSTRAINT FK_BB62E2196CEFAD37 FOREIGN KEY (permiso_id) REFERENCES permiso (id) ON DELETE CASCADE');
